...
-- lazygit
map("n", "gzl", function() Util.terminal({ "lazygit" }, { cwd = Util.root(), esc_esc = false, ctrl_hjkl = false }) end, { desc = "Lazygit (root dir)" })
map("n", "gzL", function() Util.terminal({ "lazygit" }, {esc_esc = false, ctrl_hjkl = false}) end, { desc = "Lazygit (cwd)" })
...
-- map("n", "<eeader><tab>[", "<cmd>tabprevious<cr>", { desc = "Previous Tab" })
