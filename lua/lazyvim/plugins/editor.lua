...
return {
  ...
  -- directory is a git repo.
  {
    ...
    keys = {
      ...
      { "<leader>oc", Util.telescope.config_files(), desc = "Find Config File" },
      -- TODO use a ge mapping for find file helpers gw is also an open mapping
      -- separate them from the plugin changes, just comment out the defaults
      -- { "<leader>oF", Util.telescope("files"), desc = "Find Files (cwd)" },
      { "<leader>of", Util.telescope("files", { cwd = false, hidden = true }), desc = "Find Files (root dir)" },
      { "<leader>og", "<cmd>Telescope git_files<cr>", desc = "Find Files (git-files)" },
      { "<leader>or", "<cmd>Telescope oldfiles<cr>", desc = "Recent" },
      { "<leader>oR", Util.telescope("oldfiles", { cwd = vim.loop.cwd() }), desc = "Recent (cwd)" },
      -- git
      -- { "<leader>gc", "<cmd>Telescope git_commits<CR>", desc = "commits" },
      { "<leader>os", "<cmd>Telescope git_status<CR>", desc = "status" },
      { "<leader>ol", Util.telescope("files"), { cwd = "./" .. vim.fn.expand("%:h:.") }, desc = "Find Files (cwd)" },
      -- search
